...
#define BLYNK_TEMPLATE_ID "TMPL3n0ZATsku"
#define BLYNK_TEMPLATE_NAME "Smart Plant Monitoring"
#define BLYNK_AUTH_TOKEN "tk9lMsKteiB9VD_YvbCOzLI3jtk6qUub"
...
char auth[] = "tk9lMsKteiB9VD";  // Enter your Blynk Auth token
char ssid[] = "Himanshu";  // Enter your WIFI SSID
...
void soilMoistureSensor() {
  ...
  if (value < SOIL_MOISTURE_THRESHOLD) {
    Serial.println("Low soil moisture! Water the plant.");
    // Add additional actions for low soil moisture if needed
  }
}
